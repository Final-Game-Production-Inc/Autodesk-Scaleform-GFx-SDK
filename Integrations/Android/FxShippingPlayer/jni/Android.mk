...
LOCAL_C_INCLUDES := $(SOURCE_PATH) $(SOURCE_PATH)/Include $(SOURCE_PATH)/Src $(SOURCE_PATH)/Src/Sound $(SOURCE_PATH)/Src/Platform
LOCAL_C_INCLUDES += $(SOURCE_PATH)/Apps/ShippingPlayer $(SOURCE_PATH)/Apps/Samples/Common LocalApps/$(SF_APP_NAME)
...
LOCAL_SRC_FILES := Src/Platform/Platform_Android_GL.cpp           \
                   Apps/ShippingPlayer/FxShippingPlayer.cpp \
