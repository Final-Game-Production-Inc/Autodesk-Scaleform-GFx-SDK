...
class FixedBitSetView
{
public:
    FixedBitSetView(UByte* data, unsigned bitsCount)
    : pData(data)
    , BitsCount(bitsCount)
    {
    }
...
class FixedBitSetBase : public FixedBitSetView
{
public:
    FixedBitSetBase(const void* pheapAddr, unsigned bitsCount)
        : FixedBitSetView(NULL, bitsCount)
    {
    ...
    FixedBitSetBase(const FixedBitSetBase& other)
        : FixedBitSetView(NULL, other.BitsCount)
    {
        unsigned dataLen = (BitsCount + 7)/8;
