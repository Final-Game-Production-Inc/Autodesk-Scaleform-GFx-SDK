...
{
#if defined(SF_OS_WIN32) || defined(SF_OS_XBOX360) || defined(SF_OS_WII)
...
{
#if defined(SF_OS_WIN32) || defined(SF_OS_XBOX360) || defined(SF_OS_PS3) || defined(SF_OS_WII) || defined(SF_OS_LINUX)
    return wcscoll(a, b);
#else
