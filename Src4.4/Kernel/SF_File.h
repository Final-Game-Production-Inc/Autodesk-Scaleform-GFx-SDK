...
public:
    ...
    // ** File Information                                                      
    virtual bool        IsValid() const                                         { return pFile && pFile->IsValid(); }   
    virtual bool        IsWritable() const                                      { return pFile->IsWritable(); }
...
protected:  
    ...
    BufferedFile& operator =(const BufferedFile &source);
