...
public:
    ...
    virtual bool    SetContext(Render::HAL* hal);
...
protected:
    ...
    virtual bool    WaitFence(FenceType waitType, UInt64 handle, const FenceFrame& parent);
    ...
    HAL*    pHal;
    bool    ProcessingLoseContext;  // Indicates the system is within the LoseContext call (used to skip glDeleteSync).
};
