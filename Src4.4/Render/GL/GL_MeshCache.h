...
protected:
    ...
    MeshCacheItem(MeshType type, MeshCacheListSet* pcacheList, MeshBaseContent& mc, MeshBuffer* pvb, MeshBuffer* pib, 
    ...
    Ptr<HALGLVertexArray>   VAO;                            // The vertex array object name this item uses. 
...
public:
    ...
    void                    Unmap();
    const Ptr<HALGLBuffer>  GetBuffer() { return Buffer; }
...
protected:
    ...
    HALGLBuffer                 MaskEraseBatchVertexBuffer;
    HALGLVertexArray            MaskEraseBatchVAO;
    ...
    void            destroyPendingBuffers(bool lost=false);
