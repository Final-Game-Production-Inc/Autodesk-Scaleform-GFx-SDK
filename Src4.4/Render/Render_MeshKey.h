...
public:
    ...
    { return pDelegate->GetData(hal, mesh, out, meshGenFlags); }
    ...
    virtual void        GetFillMatrix(HAL* hal, MeshBase *mesh, Matrix2F* matrix, unsigned layer,
                                      unsigned fillIndex, unsigned meshGenFlags)
    { pDelegate->GetFillMatrix(hal, mesh, matrix, layer, fillIndex, meshGenFlags); }
...
// a single object of this class is created by HAL.
//
