...
{
public:
    GlyphTextureMapper() : Valid(false), Method(0), pTexMan(0), Mapped(false),
        NumGlyphsToUpdate(0) 
    {}
...
public:
    ...
    GlyphNode*  RasterizeGlyph(HAL* hal, GlyphRunData& data, TextMeshProvider* tm, const GlyphParam& gp);
    GlyphNode*  RasterizeShadow(HAL* hal, GlyphRunData& data, TextMeshProvider* tm, const GlyphParam& gp, float screenSize, const GlyphRaster* ras);
    ...
    VectorGlyphShape* CreateGlyphShape(GlyphRunData& data, const ToleranceParams& param, unsigned glyphIndex, float screenSize, 
...
private:
    ...
    void copyAndTransformShape(VectorGlyphShape* glyphShape, const ToleranceParams& param, 
                               const ShapeDataInterface* srcShape, 
                               bool fauxBold, bool fauxItalic, unsigned outline, 
    ...
    void addShapeToRasterizer(const ShapeDataInterface* shape, const ToleranceParams& param, float scaleX, float scaleY);
    void addShapeAutoFit(const ShapeDataInterface* shape, const ToleranceParams& param, unsigned nomHeight, 
