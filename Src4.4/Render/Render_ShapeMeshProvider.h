...
public:
    ...
    virtual bool    GetData(HAL* hal, MeshBase *pmesh, VertexOutput* pout, unsigned meshGenFlags);
    ...
    virtual void        GetFillMatrix(HAL* hal, MeshBase *mesh, Matrix2F* matrix, unsigned drawLayer,
                                      unsigned fillIndex, unsigned meshGenFlags);
...
private:
    ...
    bool generateImage9Grid(HAL* hal, Scale9GridInfo* s9g, VertexOutput* verOut, unsigned drawLayer);

    bool tessellateFill(HAL* hal, const Scale9GridInfo* s9g, unsigned drawLayerIdx, MeshBase *pmesh, 
                        VertexOutput* pout, unsigned meshGenFlags);

    bool tessellateStroke(HAL* hal, const Scale9GridInfo* s9g, unsigned drawStyleIdx, unsigned shapeLayerIdx,
