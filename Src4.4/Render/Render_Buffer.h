...
inline RenderTargetData::RenderTargetData(RenderBuffer* buffer, DepthStencilBuffer* pdsb) : 
pDepthStencilBuffer(pdsb), CacheID(0), pBuffer(buffer)
{
}

inline RenderTargetData::~RenderTargetData() 
{

}

inline void RenderTargetData::StripDepthStencilTarget()
{
...
public:
    ...
    DepthStencilBuffer(DepthStencilSurface* surface)
        : RenderBuffer(0, RBuffer_UserDepthStencil, surface ? surface->GetSize() : ImageSize(0))
    {
        initSurface(surface);
    }
...
protected:
    void initSurface(DepthStencilSurface* surface) { pSurface = surface; }
...
//---------------------------------------------------------------------------------------
inline void RenderBuffer::destroyRenderTargetData()
{
