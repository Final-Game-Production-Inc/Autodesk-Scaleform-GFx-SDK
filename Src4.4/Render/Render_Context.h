...
// to HAL::Draw method. DisplyHandle implementation is essentially a
...
protected:
    ...
    {
        SF_DEBUG_WARNONCE(1, "RenderNotify::entryChanges is not implemented. Content will not update.");
    }
    virtual void    entryDestroy(Entry*) 
    {
        SF_DEBUG_WARNONCE(1, "RenderNotify::entryDestroy is not implemented.");
    }

    // Called from ShutdownRendering.
    virtual void    entryFlush(Entry*)
    {
        SF_DEBUG_WARNONCE(1, "RenderNotify::entryFlush is not implemented.");
    }
...
class ContextCaptureNotify : public RefCountBase<ContextCaptureNotify, Stat_Default_Mem>, public ListNode<ContextCaptureNotify>
{
    friend class Context;
public:
...
public:
    ...
    typedef ArrayLH<Ptr<ContextCaptureNotify> > CaptureNotifyListType;
...
private:
    ...
    CaptureNotifyListType CaptureNotifyList;
