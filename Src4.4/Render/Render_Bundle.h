...
struct SortKeyInterface
{
    ...
    // and 
    virtual bool UpdateBundleEntry(HAL*, SortKeyData, BundleEntry*, TreeCacheRoot*, const BundleIterator&) { return false; }
    virtual void DrawBundleEntry(HAL*, SortKeyData, BundleEntry*) { }
...
public:
    ...
    bool UpdateBundleEntry(HAL* hal, BundleEntry* e, TreeCacheRoot* tr, const BundleIterator& ibundles)
    { 
        return pImpl->UpdateBundleEntry(hal, Data, e, tr, ibundles); 
    }

    void DrawBundleEntry(HAL* hal, BundleEntry* e)
    { 
        pImpl->DrawBundleEntry(hal, Data, e); 
    }
};
...
public:
    ...
    bool UpdateBundleEntry(HAL* hal, TreeCacheRoot* tr, const BundleIterator& ibundles);

    void DrawBundleEntry(HAL* hal)
    {
        Key.DrawBundleEntry(hal, this);
    }
...
public:
    ...
    Bundle(HAL* hal, BundleEntry* top) : NeedUpdate(true)
    {
        FrameId =0;
        UpdateChain(hal, top);
        NeedUpdate = true;
    ...
    void UpdateChain(HAL* hal, BundleEntry *newTop);
    ...
    virtual void InsertEntry(HAL* hal, UPInt index, BundleEntry* shape);
    virtual void RemoveEntries(UPInt index, UPInt count);
    virtual void UpdateMesh(HAL* hal, BundleEntry* entry);
