    ...
    StatMV_Mem,
      ...
      StatMV_VM,
        ...
        StatMV_VM_VMAbcFile_Mem,
            StatMV_VM_VMAbcFileIntNs_Mem,
            StatMV_VM_VMAbcFileIntNsSet_Mem,
            StatMV_VM_VMAbcFileIntStr_Mem,
            StatMV_VM_VMAbcFileBubble_Mem,
            StatMV_VM_VMAbcFileMBIArray_Mem,
            StatMV_VM_VMAbcFileWordCode_Mem,
        StatMV_VM_Tracer_Mem,
        StatMV_VM_DebugInfo_Mem,
