...
class   SharedObject3ManagerBase;
...
public:
    ...
    inline void                 SetSharedObject3Manager(SharedObject3ManagerBase *ptr);
    inline Ptr<SharedObject3ManagerBase> GetSharedObject3Manager() const;
#endif
...
#define GFX_LOADER_NEW_ZLIBSUPPORT *new Scaleform::GFx::ZlibSupport    
#else
    #define GFX_LOADER_NEW_ZLIBSUPPORT ((Scaleform::GFx::ZlibSupport*)0)
#endif
