...
public:
    void ClearPlayOptList() { pPlayNextOpt = pPlayPrevOpt = NULL; }
    void ClearPlayList() { pPlayNext = pPlayPrev = NULL; }
    void ClearLists()
    {
        ClearPlayOptList();
        ClearPlayList();
    ...
    InteractiveObject* GetPlayPrev() const { return pPlayPrev; }
    void SetPlayPrev(InteractiveObject* v) { pPlayPrev = v; }

    InteractiveObject* GetPlayNext() const { return pPlayNext; }
    void SetPlayNext(InteractiveObject* v) { pPlayNext = v; }

    InteractiveObject* GetPlayPrevOpt() const { return pPlayPrevOpt; }
    void SetPlayPrevOpt(InteractiveObject* v) { pPlayPrevOpt = v; }

    InteractiveObject* GetPlayNextOpt() const { return pPlayNextOpt; }
    void SetPlayNextOpt(InteractiveObject* v) { pPlayNextOpt = v; }

    InteractiveObject* GetNextUnloaded() const { return pNextUnloaded; }
    void SetNextUnloaded2(InteractiveObject* v) { pNextUnloaded = v; }
