...
namespace AOT
{
    ...
    struct UMbiInd
    {
        ...
        {
            return Abc::MbiInd(static_cast<SInt32>(Method));
        }
    ...
    struct InfoCollector
    {
        ...
        typedef HashSetDH<SPtr<InstanceTraits::fl::Function> > TFunctHashSet;
        ...
        void MakeFunctionName(StringBuffer& buf, const InstanceTraits::fl::Function& tr) const;
        String MakeFunctionName(const InstanceTraits::fl::Function& tr) const
        {
            StringBuffer buf;
