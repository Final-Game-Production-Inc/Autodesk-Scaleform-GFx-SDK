...
//##protect##"instance$methods"
    ...
    public:
        ...
        void beginGradientFill(Value& result, unsigned argc, Value* const argv);
        ...
        void drawRoundRectComplex(Value& result, unsigned argc, Value* const argv);
        void endFill(const Value& result);
        void lineGradientStyle(Value& result, unsigned argc, Value* const argv);
        void lineStyle(Value& result, unsigned argc, Value* const argv);
