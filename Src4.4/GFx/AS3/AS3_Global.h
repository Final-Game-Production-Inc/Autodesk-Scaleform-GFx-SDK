...
namespace fl
{
    ...
    extern const ClassInfo void_CI;
}
...
namespace fl_display
{
    ...
    extern const ClassInfo ShaderParameterCI;
    extern const ClassInfo ShaderParameterTypeCI;
    extern const ClassInfo ShaderPrecisionCI;
    extern const ClassInfo ShaderJobCI;
    extern const ClassInfo ShaderInputCI;
}
...
namespace fl_geom
{
    ...
    extern const ClassInfo Utils3DCI;
...
//##begin##"obj_global_cpp$inheritance_table"
        ...
        &AS3::fl_display::ShaderParameterCI,
        &AS3::fl_display::ShaderParameterTypeCI,
        &AS3::fl_display::ShaderPrecisionCI,
        &AS3::fl_display::ShaderJobCI,
        &AS3::fl_display::ShaderInputCI,
