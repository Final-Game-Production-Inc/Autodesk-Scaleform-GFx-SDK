...
class RTCommandMF4R : public RTCommand
{
    typedef R (C::*FuncPtrType)(A0, A1, A2, A3);
    C*              pClass;
    FuncPtrType     pFunc;
    R*              pRet;
    typename RTClean<A0>::Type A0Val;
    ...
    typename RTClean<A3>::Type A3Val;
public:
    RTCommandMF4R(C* c, FuncPtrType fn, R* ret, A0 a0, A1 a1, A2 a2, A3 a3, WaitType wt)
        : RTCommand(Command_MFunc, sizeof(RTCommandMF4R), wt),
        pClass(c), pFunc(fn), pRet(ret), A0Val(a0), A1Val(a1), A2Val(a2), A3Val(a3) { }

    virtual void  Execute(RTCommandQueue&) const
    { *pRet = (pClass->*pFunc)(A0Val, A1Val, A2Val, A3Val); }
};
...
public:
 ...
 /*
   ...
   */
    ...
    template<class C, class R, class A0, class A1, class A2, class A3>
    bool    PushCallAndWaitResult(R (C::*func)(A0, A1, A2, A3), R* ret,
        typename RTSelf<A0>::Type a0, typename RTSelf<A1>::Type a1, typename RTSelf<A2>::Type a2, typename RTSelf<A3>::Type a3)
    { return PushCommandAndWait(RTCommandMF4R<C, R, A0, A1, A2, A3>((C*)this, func, ret, a0, a1, a2, a3, RTCommand::Wait)); }
