...
public:
    ...
    virtual void OnDisplay(Render::HAL* hal) = 0;
    virtual void OnShutdown(Render::HAL* hal) = 0;
};
...
// RenderThread adds support for rendering of a display handle.
...
protected:
    ...
    virtual void captureFrameWithoutDraw();
    virtual void drawFrame();
    virtual void drawFrame(DisplayWindow* pdispwin);
    virtual void drawFrameMono(DisplayWindow* pdispwin, bool capture);
    ...
    Ptr<Render::HAL>             pRenderer;              // The Renderer. Can only be accessed from the render thread.
    Render::GlyphCacheParams     GCParams;               // Parameters copy stored before HAL initialization.
    Render::ToleranceParams      TolParams;              // Parameters copy stored before HAL initialization.
