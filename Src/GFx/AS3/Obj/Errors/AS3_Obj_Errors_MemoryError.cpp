...
namespace ClassTraits { namespace fl_errors
{
    ...
    MemoryError::MemoryError(VM& vm, const ClassInfo& ci)
    : fl::Error(vm, ci)
    {
...
//##protect##"ClassTraits::MemoryError::MemoryError()"
    ...
    Pickable<Traits> MemoryError::MakeClassTraits(VM& vm)
    {
        ...
        Pickable<Traits> ctr(SF_HEAP_NEW_ID(mh, StatMV_VM_CTraits_Mem) MemoryError(vm, AS3::fl_errors::MemoryErrorCI));

        Pickable<InstanceTraits::Traits> itr(SF_HEAP_NEW_ID(mh, StatMV_VM_ITraits_Mem) InstanceTraitsType(vm, AS3::fl_errors::MemoryErrorCI));
...
namespace fl_errors
{
    const TypeInfo MemoryErrorTI = {
        ...
        sizeof(ClassTraits::fl_errors::MemoryError::InstanceType),
        0,
        0,
        0,
        0,
