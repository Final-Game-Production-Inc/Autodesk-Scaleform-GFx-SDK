...
{
    class GradientGlowFilter : public Instances::fl_filters::BitmapFilter
    {
#ifndef SF_OS_WII
        template <class TR> friend Pickable<typename TR::InstanceType> InstanceTraits::MakeInstance(TR& tr);
#endif
        friend class InstanceTraits::fl_filters::GradientGlowFilter;
        
    public:
        typedef GradientGlowFilter SelfType;
        typedef Classes::fl_filters::GradientGlowFilter ClassType;
        typedef InstanceTraits::fl_filters::GradientGlowFilter TraitsType;
        static const TypeInfo& GetTypeInfo() { return AS3::fl_filters::GradientGlowFilterTI; }

#ifdef GFX_AS3_VERBOSE
    private:
        virtual const char* GetAS3ObjectType() const { return "Instances::fl_filters::GradientGlowFilter"; }
#endif
#ifdef SF_OS_WII
    public:
#else
    protected:
#endif
        GradientGlowFilter(InstanceTraits::Traits& t);

//##protect##"instance$methods"
        virtual void AS3Constructor(unsigned argc, const Value* argv);
        Render::GradientFilter* GetGradientGlowFilterData() const { return (Render::GradientFilter*)GetFilterData(); }
...
namespace InstanceTraits { namespace fl_filters
{
    class GradientGlowFilter : public fl_filters::BitmapFilter
    {
#ifdef GFX_AS3_VERBOSE
    private:
        virtual const char* GetAS3ObjectType() const { return "InstanceTraits::GradientGlowFilter"; }
#endif
    public:
        typedef Instances::fl_filters::GradientGlowFilter InstanceType;

    public:
        GradientGlowFilter(VM& vm, const ClassInfo& ci);

    public: 
        static Pickable<Instances::fl_filters::GradientGlowFilter> MakeInstance(GradientGlowFilter& t)
        {
            return Pickable<Instances::fl_filters::GradientGlowFilter>(new(t.Alloc()) Instances::fl_filters::GradientGlowFilter(t));
        }
        SPtr<Instances::fl_filters::GradientGlowFilter> MakeInstanceS(GradientGlowFilter& t)
        {
...
namespace ClassTraits { namespace fl_filters
{
    ...
    public:
        ...
        typedef InstanceTraits::fl_filters::GradientGlowFilter InstanceTraitsType;
