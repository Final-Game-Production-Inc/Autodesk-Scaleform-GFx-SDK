...
#if defined(SF_OS_PSP) || defined(SF_OS_PS2) || defined(SF_OS_PS3) || \
...
#if !defined(SF_FLOATING_POINT_FAST) && defined(SF_OS_WINMETRO) && defined(SF_OS_DURANGO) && defined(SF_CPU_X86_64)
//    #define SF_FLOATING_POINT_FAST
#endif
...
// Define this macro to enable video support (including core and ActionScript)
    ...
    defined(SF_OS_ORBIS)   || (defined(SF_OS_LINUX) && defined(SF_CPU_X86_64) && !defined(SF_OS_ANDROID)))
...
#if defined(SF_OS_WIN32) || defined(SF_OS_PS3) || defined(SF_OS_XBOX360) || defined(SF_OS_PSVITA) || \
    defined(SF_OS_WIIU)  || defined(SF_OS_3DS) || defined(SF_OS_ORBIS)
...
#if defined(SF_BUILD_SHIPPING)
    // Turn verbose action OFF for shipping builds
    #undef GFX_AS2_VERBOSE
    #undef GFX_AS3_VERBOSE
#endif

// Enable cloning of user-defined objects. This is a performance-related option.
#define SF_AS3_OBJ_CLONING

#ifdef SF_AS3_OBJ_CLONING
    // Create an object clone after SF_AS3_OBJ_CLONING_COUNTER attempts.
    // If SF_AS3_OBJ_CLONING_COUNTER is not defined, object clones will be created on first attempt.
    #define SF_AS3_OBJ_CLONING_COUNTER 4
#endif

// Define SF_AS3_OBJ_POOLING if you want to boost performance.
// More memory will be used in this case.
// #define SF_AS3_OBJ_POOLING

#ifdef SF_AS3_OBJ_POOLING
    // Clean Object Pool during garbage collection.
    // Object Pool is using more memory, but it also causing less memory fragmentation,
    // what in the end leads to smaller total amount of used memory.
    #define SF_AS3_OBJ_POOLING_CLEAN_IN_GC
#endif

// Define SF_AS3_MAX_PERFORMANCE if you want to boost performance.
// More memory will be used in this case.
...
// Define SF_AS3_MIN_MEMORY if you want to minimize memory usage.
// This will affect performance.
//#define SF_AS3_MIN_MEMORY

#ifdef SF_AS3_MIN_MEMORY
    #ifdef SF_AS3_OBJ_CLONING
        #undef SF_AS3_OBJ_CLONING
    #endif
    #ifdef SF_AS3_OBJ_CLONING_COUNTER
        #undef SF_AS3_OBJ_CLONING_COUNTER
    #endif
...
//option to undefine SF_AS3_VERSION_AIR
//#define NO_SF_AS3_VERSION_AIR
#ifdef NO_SF_AS3_VERSION_AIR
	#undef SF_AS3_VERSION_AIR
#endif
...
#if (defined (SF_OS_IPHONE) || defined (SF_OS_ANDROID) || defined (SF_OS_MAC) || defined (SF_OS_WIN32) || defined SF_OS_PS3) && !(defined (SF_OS_DURANGO) || defined (SF_OS_WINMETRO))
...
//---------------------------------------------------------------------------
    ...
    #undef GFX_AS2_ENABLE_RECTANGLE
        ...
        // GASPoint is useless without GASRectangle and GASMatrix
        #undef GFX_AS2_ENABLE_POINT
    #endif
#endif
